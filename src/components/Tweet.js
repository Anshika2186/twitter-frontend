...
function Tweet(props) {
  ...
  async function populateComments() {
    const req = await fetch(`https://twitter-backend-gsqq.onrender.com/feed/comments/${tweetId}`, {
      headers: {
          ...
          <li className="tweet-items">
            ...
            <div className="parent-flex-introduction">
              <img
                ...
                src={`https://twitter-backend-gsqq.onrender.com/images/${props.body.postedBy.avatar}`}
              ></img>
                    ...
                    <ul className="delete-popup" style={{ listStyle: "none" }}>
                      <li>
                        <form
                          ...
                          action={`https://twitter-backend-gsqq.onrender.com/deleteTweet/${tweetId}`}
                          ...
                          {(close) => (
                            <div className="comment-modal">
                              <form
                                ...
                                action={`https://twitter-backend-gsqq.onrender.com/editTweet/${tweetId}`}
                              >
                                <input
                                  required
                                  autoFocus
            ...
            <div className="icons">
              <div style={{ color: btnColor }} className="icon">
                <form
                  ...
                  className="likeForm"
                  action={`https://twitter-backend-gsqq.onrender.com/post/${props.user}/like/${tweetId}`}
                  method="post"
                >
                  <button>
                    <AiOutlineLike />
              ...
              <div style={{ color: retweetBtnColor }} className="icon retweet">
                <form
                  ...
                  action={`https://twitter-backend-gsqq.onrender.com/post/${props.user}/retweet/${tweetId}`}
                >
                  <button>
                    <AiOutlineRetweet />
                ...
                {(close) => (
                  <div className="comment-modal">
                    ...
                    <form
                      ...
                      method="post"
                      action={`https://twitter-backend-gsqq.onrender.com/feed/comment/${tweetId}`}
                    >
                      <input
                        autoFocus
                        required
