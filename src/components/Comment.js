            ...
            <ul className="delete-popup" style={{ listStyle: "none" }}>
              <li>
                <form
                  ...
                  action={`https://twitter-backend-gsqq.onrender.com/deleteComment/${commentId}`}
                ...
                >
                  <div className="comment-modal">
                    <form
                      ...
                      action={`https://twitter-backend-gsqq.onrender.com/editComment/${commentId}`}
                    >
                      <input
                        required
                        autoFocus
      ...
      <div className="icons">
        <div style={{ color: btnColor }} className="icon">
          <form
            ...
            className="likeForm"
            action={`https://twitter-backend-gsqq.onrender.com/comment/${props.user}/like/${commentId}`}
            method="post"
          >
            <button>
              <AiOutlineLike />
